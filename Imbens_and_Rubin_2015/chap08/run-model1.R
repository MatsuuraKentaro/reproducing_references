...
data <- list(N = nrow(d), Y_obs = d$re78/1000, W = d$treat, Rho = 1 - 1e-6)
model <- cmdstan_model(stan_file = 'model/chap08-model1.stan')
...
# tau_fs: 1.79 (0.63)
# tau_quant_25: 1.79 (0.63)
# tau_quant_50: 1.79 (0.63)
# tau_quant_75: 1.79 (0.63)